...
downloadSampleTemperatureSensorCalibrationCurve = getattr(attoDRYLib,
                                                          'AttoDRY_Interface_downloadSampleTemperatureSensorCalibrationCurve')
downloadTemperatureSensorCalibrationCurve = getattr(attoDRYLib,
                                                    'AttoDRY_Interface_downloadTemperatureSensorCalibrationCurve')
uploadSampleTemperatureCalibrationCurve = getattr(attoDRYLib,
