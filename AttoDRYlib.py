...
def checkError(code, func, args):
    if code == EC_Ok:
        ...
        raise Exception(
            "Error 1: High liquid helium reservoir temperature. Action: Wait for it to cool."
        )
    elif code == 2:
        raise Exception("Error 2: High pressure. Action: Wait for it to drop.")
    elif code == 3:
        raise Exception(
            "Error 3: The temperature monitor has not initialised properly. Action: Turn the AttoDRY off and on."
        )
    elif code == 4:
        raise Exception(
            "Error 4: There is a fault with channel A on the temperature Monitor. Action: Turn the attoDRY off and on. If this error occurs repeatedly, contact attocube."
        )
    elif code == 5:
        raise Exception(
            "Error 5: There is a fault with channel B on the temperature Monitor. Action: Turn the attoDRY off and on. If this error occurs repeatedly, contact attocube."
        )
    elif code == 6:
        raise Exception(
            "Error 6: There is a fault with channel C on the temperature Monitor. Action: Turn the attoDRY off and on. If this error occurs repeatedly, contact attocube."
        )
    elif code == 7:
        raise Exception(
            "Error 7: There is a fault with channel D on the temperature Monitor. Action: Turn the attoDRY off and on. If this error occurs repeatedly, contact attocube."
        )
    elif code == 8:
        raise Exception(
            "Error 8: The temperature monitor has not responded within a ceratin amount of time. Action: Lower the error. If the error occurs again, try restarting the attoDRY. If this occurs again, contact attocube."
        )
    elif code == 9:
        raise Exception(
            "Error 9: Excessive pump link voltage. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 10:
        raise Exception(
            "Error 10: Excessive pump motor current. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 11:
        raise Exception(
            "Error 11: Excessive pump controller temperature. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube. Make sure the pump is in a well-ventilated area."
        )
    elif code == 12:
        raise Exception(
            "Error 12: Pump controller temp sensor failure. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 13:
        raise Exception(
            "Error 13: Pump power stage failure. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 17:
        raise Exception(
            "Error 17: Critical pump EEPROM problem. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 19:
        raise Exception(
            "Error 19: Pump parameter set upload required. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 20:
        raise Exception(
            "Error 20: Pump self-test fault (invalid pump software code). Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 21:
        raise Exception(
            "Error 21: Pump serial enable input went inactive whilst operating with a serial start command. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube. Ensure the cable between the pump and the attoDRY is plugged in properly."
        )
    elif code == 22:
        raise Exception(
            "Error 22: Pump output frequency dropped below threshold for too long. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube. This error may occur if the pressure suddenly increases in the pumping line."
        )
    elif code == 23:
        raise Exception(
            "Error 23: Pump output frequency did not reach threshold in allowable time. Action: Turn off the attoDRY, switch the pump on and off again. Turn the attoDRY on. If this occurs again, contact attocube."
        )
    elif code == 24:
        raise Exception(
            "Error 24: Error processing pump response. Action: Try to send the command again."
        )
    elif code == 29:
        raise Exception(
            "Error 29: Error with pump inlet pressure gauge. Action: Check the light on top of the pressure gauge. If it is off, ensure everything is plugged correctly. If it is red or green, try switching the power on and off. Contact attocube if the light stays off or red."
        )
    elif code == 30:
        raise Exception(
            "Error 30: Error with the pump outlet pressure gauge. Action: Check the light on top of the pressure gauge. If it is off, ensure everything is plugged in correctly. If it is red or green, try switching the power on and off. Contact attocube if the light stays off or red."
        )
    elif code == 31:
        raise Exception(
            "Error 31: Error with the helium dump pressure gauge. Action: Check the light on top of the pressure gauge. If it is off, ensure everything is plugged in correctly. If it is red or green, try switching the power on and off. Contact attocube if the light stays off or red."
        )
    elif code == 32:
        raise Exception(
            "Error 32: Error with compressor. Action: Check the compressor display for more information."
        )
    elif code == 33:
        raise Exception(
            "Error 33: VTI temperature is too high; everything is stopped to prefent damage. Action: Wait for the temperature to drop. If this occurs repeatedly, contact attocube."
        )
    elif code == 34:
        raise Exception(
            "Error 34: The temperature monitor has given invalid temperatures for too long. Unable to control the temperature. This can occur when changing temperature monitor settings e.g. sensor exictation ranges. Action: Check all temperature sensor cables are connected and try again. If the error occurs again, restart the attoDRY. If you changed a setting on the temperature monitor, wait a few seconds and start controlling again."
        )
    elif code == 35:
        raise Exception(
            "Error 35: An operation has been requested that requires the magnet controller and there is not one connected. Action: Ensure magnet controller is connected, switched on, and communication is configured. Restart attoDRY."
        )
    elif code == 36:
        raise Exception(
            "Error 36: An operation with the magnet controller requires it to be in remote mode when it is not. Action: The magnet controller must be in remote mode. Ensure the magnet controller is not in local mode."
        )
    elif code == 37:
        raise Exception(
        ...
        raise Exception(
            "Error 38: Magnet controller power module failure. Action: Contact attocube."
        )
    elif code == 39:
        raise Exception(
            "Error 39: Error with chip 1 on motor driver 1. Action: Restart attoDRY. Contact attocube if problem persists."
        )
    elif code == 40:
        raise Exception(
            "Error 40: Error with chip 1 on motor driver 2. Action: Restart attoDRY. Contact attocube if problem persists."
        )
    elif code == 41:
        raise Exception(
            "Error 41: Error with chip 1 on motor driver 3. Action: Restart attoDRY. Contact attocube if problem persists."
        )
    elif code == 42:
        raise Exception(
            "Error 42: Error with chip 1 on motor driver 4. Action: Restart attoDRY. Contact attocube if problem persists."
        )
    elif code <= EC_Error:
        raise Exception(
            "Error: unspecific in" + str(func.__name__) + "with parameters:" + str(args)
        )
    else:
...
downloadSampleTemperatureSensorCalibrationCurve = getattr(
    attoDRYLib, "AttoDRY_Interface_downloadSampleTemperatureSensorCalibrationCurve"
)
downloadTemperatureSensorCalibrationCurve = getattr(
    attoDRYLib, "AttoDRY_Interface_downloadTemperatureSensorCalibrationCurve"
)
uploadSampleTemperatureCalibrationCurve = getattr(
    attoDRYLib, "AttoDRY_Interface_uploadSampleTemperatureCalibrationCurve"
)
uploadTemperatureCalibrationCurve = getattr(
    attoDRYLib, "AttoDRY_Interface_uploadTemperatureCalibrationCurve"
)

##### asking questions
isControllingField = getattr(attoDRYLib, "AttoDRY_Interface_isControllingField")
isControllingTemperature = getattr(
    attoDRYLib, "AttoDRY_Interface_isControllingTemperature"
)
...
isGoingToBaseTemperature = getattr(
    attoDRYLib, "AttoDRY_Interface_isGoingToBaseTemperature"
)
...
isSampleExchangeInProgress = getattr(
    attoDRYLib, "AttoDRY_Interface_isSampleExchangeInProgress"
)
isSampleHeaterOn = getattr(attoDRYLib, "AttoDRY_Interface_isSampleHeaterOn")
isSampleReadyToExchange = getattr(
    attoDRYLib, "AttoDRY_Interface_isSampleReadyToExchange"
)
...
##### queries
queryReservoirTsetColdSample = getattr(
    attoDRYLib, "AttoDRY_Interface_queryReservoirTsetColdSample"
)
queryReservoirTsetWarmMagnet = getattr(
    attoDRYLib, "AttoDRY_Interface_queryReservoirTsetWarmMagnet"
)
queryReservoirTsetWarmSample = getattr(
    attoDRYLib, "AttoDRY_Interface_queryReservoirTsetWarmSample"
)
querySampleHeaterMaximumPower = getattr(
    attoDRYLib, "AttoDRY_Interface_querySampleHeaterMaximumPower"
)
querySampleHeaterResistance = getattr(
    attoDRYLib, "AttoDRY_Interface_querySampleHeaterResistance"
)
querySampleHeaterWireResistance = getattr(
    attoDRYLib, "AttoDRY_Interface_querySampleHeaterWireResistance"
)
...
toggleExchangeHeaterControl = getattr(
    attoDRYLib, "AttoDRY_Interface_toggleExchangeHeaterControl"
)
toggleFullTemperatureControl = getattr(
    attoDRYLib, "AttoDRY_Interface_toggleFullTemperatureControl"
)
...
toggleMagneticFieldControl = getattr(
    attoDRYLib, "AttoDRY_Interface_toggleMagneticFieldControl"
)
...
toggleSampleTemperatureControl = getattr(
    attoDRYLib, "AttoDRY_Interface_toggleSampleTemperatureControl"
)
...
getReservoirHeaterPower = getattr(
    attoDRYLib, "AttoDRY_Interface_getReservoirHeaterPower"
)
getReservoirTemperature = getattr(
    attoDRYLib, "AttoDRY_Interface_getReservoirTemperature"
)
getReservoirTsetColdSample = getattr(
    attoDRYLib, "AttoDRY_Interface_getReservoirTsetColdSample"
)
getReservoirTsetWarmMagnet = getattr(
    attoDRYLib, "AttoDRY_Interface_getReservoirTsetWarmMagnet"
)
getReservoirTsetWarmSample = getattr(
    attoDRYLib, "AttoDRY_Interface_getReservoirTsetWarmSample"
)
...
getMagneticFieldSetPoint = getattr(
    attoDRYLib, "AttoDRY_Interface_getMagneticFieldSetPoint"
)
getProportionalGain = getattr(attoDRYLib, "AttoDRY_Interface_getProportionalGain")
getSampleHeaterMaximumPower = getattr(
    attoDRYLib, "AttoDRY_Interface_getSampleHeaterMaximumPower"
)
getSampleHeaterPower = getattr(attoDRYLib, "AttoDRY_Interface_getSampleHeaterPower")
getSampleHeaterResistance = getattr(
    attoDRYLib, "AttoDRY_Interface_getSampleHeaterResistance"
)
getSampleHeaterWireResistance = getattr(
    attoDRYLib, "AttoDRY_Interface_getSampleHeaterWireResistance"
)
...
setReservoirTsetColdSample = getattr(
    attoDRYLib, "AttoDRY_Interface_setReservoirTsetColdSample"
)
setReservoirTsetWarmMagnet = getattr(
    attoDRYLib, "AttoDRY_Interface_setReservoirTsetWarmMagnet"
)
setReservoirTsetWarmSample = getattr(
    attoDRYLib, "AttoDRY_Interface_setReservoirTsetWarmSample"
)
setSampleHeaterMaximumPower = getattr(
    attoDRYLib, "AttoDRY_Interface_setSampleHeaterMaximumPower"
)
setSampleHeaterPower = getattr(attoDRYLib, "AttoDRY_Interface_setSampleHeaterPower")
setSampleHeaterResistance = getattr(
    attoDRYLib, "AttoDRY_Interface_setSampleHeaterResistance"
)
setSampleHeaterWireResistance = getattr(
    attoDRYLib, "AttoDRY_Interface_setSampleHeaterWireResistance"
)
